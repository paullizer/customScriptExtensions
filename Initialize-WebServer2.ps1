...
# Create temp folder
    ...
    <status>
       <service>
            <name>Upload Container Sync to Azure</name>
            <status>Green</status>
            <updated>1/1/2023 10:00 am</updated>
        </service>
        <service>
            <name>Download Container Sync to Azure</name>
            <status>Green</status>
            <updated>1/1/2023 10:00 am</updated>
        </service>
        <service>
        ...
        <service>
            <name>Azure Latency</name>
            <status>Green</status>
            <updated>1/1/2023 10:00 am - 92 ms</updated>
        </service>
    </status>'
...
# Deploy website from Git Repo to C:\inetpub\wwwroot\
    try { 
        ...
        ("Cloned git repo to c:temp\git\. ") | out-file $log -Append 
    }
    catch {
